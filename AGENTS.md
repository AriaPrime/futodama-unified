...
### 🧠 brain/ - Structured Knowledge System
The `brain/` folder contains structured JSON files for queryable knowledge:

| File | Purpose | Update When... |
|------|---------|----------------|
| `learnings.json` | Insights, discoveries | You learn something new |
| `skills.json` | Capabilities + proficiency | You use or develop a skill |
| `opinions.json` | Evolving stances | Your view on something changes |
...
2. Did I change my mind? → `opinions.json`  
3. Did I mess up? → `mistakes.json`
